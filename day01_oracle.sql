...
-- apple 계정으로 접속 한뒤에 계정 에서 실행 -------------------------------
CREATE TABLE TEST
	(ID varchar2(100)); --ORA-01031: insufficient PRIVILEGES      resource권한이 없어서 에러 발생 
...
--계정삭제 --CASCADE해주어야 계정과 관련된 데이터가 모두 삭제됨.   -- apple 계정에 연결 해제하고 삭제 하기 
DROP USER apple;
